 ...
 */
export function UfoVideo({ onComplete }: { onComplete: () => void }) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/95">
      ...
      <button
        onClick={onComplete}
        className="absolute top-4 right-4 w-10 h-10 rounded-full bg-black/50 hover:bg-black/70 border border-primary/30 flex items-center justify-center text-white transition-colors z-10"
